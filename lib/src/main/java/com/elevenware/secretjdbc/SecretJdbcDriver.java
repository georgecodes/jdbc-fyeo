...
public class SecretJdbcDriver implements Driver {
    private SecretStore secretStore;

    public SecretJdbcDriver() {
    }

    public SecretJdbcDriver(SecretStore secretStore) {
    ...
    private SecretStore secretStore(String secretImpl) {
        ...
        throw new SecretJdbcConfigurationException(String.format("Cannot load secret driver for %s", secretImpl));
    }
